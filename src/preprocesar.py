...
STOPWORDS = set(stopwords.words("spanish")) | {
    "si", "así", "tan", "también", "pero", "porque", "cuando",
    "donde", "como", "aunque", "sino", "ya", "aún", "bien", "mal",
    "solo", "ser", "estar", "haber", "tener", "hacer", "decir",
    "ver", "dar", "saber", "querer", "llegar", "película", "film",
}
