...
#hf upload <REPO_ID> <LOCAL_PATH> <REMOTE_PATH> \ --repo-type=<TYPE> \ --commit-message="<MENSAJE>"
	...
	hf upload alecorlo1234/AnalizadorSentimientos ./src/preprocesar.py /src/preprocesar.py --repo-type=space --commit-message="Sincronizar preprocesar"
	hf upload alecorlo1234/AnalizadorSentimientos ./src/explicar.py /src/explicar.py --repo-type=space --commit-message="Sincronizar explicar"
